    ...
    return (
        <main className="min-h-screen flex items-center justify-center p-6 bg-background">
            <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
                <div className="bg-card rounded-2xl border border-border p-10 shadow-xl overflow-hidden relative">
                    ...
                    <header className="text-center mb-10">
                        ...
                        <p className="text-sm text-text-muted">Ingresa tus credenciales para continuar</p>
                    </header>

                    <form onSubmit={handleLogin} className="space-y-6">
                        {error && (
                            <div className="bg-danger-subtle border border-danger-light text-danger-dark p-4 rounded-lg text-sm font-medium flex items-center gap-3">
                    ...
                    <footer className="mt-10 pt-6 border-t border-border-subtle text-center">
                        <p className="text-[10px] font-bold text-text-faint uppercase tracking-widest">PWA Comercial v1.1 • Sistema de Gestión</p>
                    </footer>
                </div>
            </div>
        </main>
